...
import { Plus, Trash2, Coffee, Utensils, Moon, Apple, ChevronDown, ChevronUp, Dumbbell, Settings, X, ChevronLeft, ChevronRight, Calendar } from 'lucide-react';
  ...
  return (
    <div className="diet-page fade-in">
      ...
      <div className="meal-cards">
        {activeKeys.map(key => {
          const master = MASTER_MEALS.find(m => m.key === key);
